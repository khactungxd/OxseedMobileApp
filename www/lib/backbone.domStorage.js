...
// window.Store is deprectated, use Backbone.LocalStorage instead
  ...
  _.extend(Backbone.LocalStorage.prototype, {
    ...
    // Add a treeModel, giving it a (hopefully)-unique GUID, if it doesn't already
    ...
    // Update a treeModel by replacing its copy in `this.data`.
    ...
    // Retrieve a treeModel from `this.data` by id.
    find: function(model) {
    ...
    // Delete a treeModel from `this.data`, returning it.
...
// localSync delegate to the treeModel or collection's
...
// sessionSync delegate to the treeModel or collection's
